        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CasVytvorenia = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CasPoslednejZmeny = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Udaje", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Produkty_UdajeProduktuId",
                table: "Produkty",
                column: "UdajeProduktuId");
        }
